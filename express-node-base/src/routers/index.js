...
routers.delete(
  "/course-registration/:registration_id",
  CourseRegistrationController.cancelCourseRegistration
);
routers.get(
  "/available-courses/:student_id",
  CourseRegistrationController.getAvailableCourses
);
routers.get(
  "/registered-courses/:student_id",
  CourseRegistrationController.viewRegisteredCourses
);
